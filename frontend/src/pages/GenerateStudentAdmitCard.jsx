...
const GenerateStudentAdmitCard = () => {
  ...
  const handlePrint = () => {
    console.log('Printing Admit cards for students:', selectedStudents);
          ...
          <Collapse in={headerExpanded}>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Typography variant="body2" sx={{ color: '#1976d2', display: 'inline' }}>
                ...
                <span style={{ cursor: 'pointer', color: '#000', fontWeight: 'bold' }}>Student Admit Card</span>
              </Typography>
            </Box>

            {/* Form Section - Variation C: Student Admit Card (5 inputs) */}
            <Box sx={{ mb: 4, display: 'flex', gap: 2, alignItems: 'flex-end', flexWrap: 'wrap' }}>
              ...
              <Button
                ...
                disabled={!formData.schoolName || !formData.examTerm || !formData.class || !formData.section || !formData.student}
                sx={{
                  backgroundColor: '#000',
                  color: '#fff',
                  height: '56px',
            ...
            {showResults && (
              <>
                {/* Tab on the left with List Name */}
                    ...
                    <TableBody>
                      {studentData.map((student, index) => (
                        <TableRow key={student.id}>
                          ...
                          <TableCell>{student.examTerm}</TableCell>
...
export default GenerateStudentAdmitCard;
