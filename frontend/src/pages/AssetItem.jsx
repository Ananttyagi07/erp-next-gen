          ...
          <CardContent sx={{ p: 3 }}>
            ...
            <Box sx={{ mb: 2 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
                ...
                <ChevronIcon sx={{ fontSize: 24, color: '#6b7280' }} />
              </Box>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3, flexWrap: 'wrap', gap: 2 }}>
              ...
              >
                <Tab icon={<ListIcon sx={{ fontSize: 16 }} />} iconPosition="start" label="List" />
                <Tab icon={<AddIcon sx={{ fontSize: 16 }} />} iconPosition="start" label="Add" />
              </Tabs>
                ...
                <Box sx={{ maxWidth: 900, mx: 'auto', px: 6, py: 4 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'flex-start', gap: 2 }}>
                    ...
                    <Button
                      ...
                      disabled={!formData.schoolName || !formData.category || !formData.name || !formData.store}
                      sx={{
                        backgroundColor: '#000',
                        color: '#fff',
                        textTransform: 'none',
