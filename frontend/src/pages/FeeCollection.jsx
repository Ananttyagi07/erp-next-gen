  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      <Paper elevation={0} sx={{ border: '1px solid #e5e5e5', borderRadius: '4px' }}>
        ...
        >
          <CalculateIcon sx={{ fontSize: 20, mr: 1, color: '#374151' }} />
          ...
          <Box sx={{ p: 3 }}>
            ...
            <Box sx={{ borderBottom: '1px solid #e5e5e5', mb: 3 }}>
              ...
              >
                ...
                <Tab icon={<AddIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Create Invoice" />
                <Tab icon={<AddIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Create Bulk Invoice" />
              </Tabs>
            </Box>
              ...
              <Box>
                ...
                <TableContainer sx={{ border: '1px solid #e5e5e5', borderRadius: '4px', mb: 2 }}>
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell colSpan={9} sx={{ textAlign: 'center', py: 4, color: '#6b7280', fontSize: '14px' }}>
                ...
                <Box sx={{ display: 'flex', gap: 4, mb: 3 }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                      <Typography sx={{ width: '150px', fontSize: '14px', color: '#6b7280' }}>
                    ...
                    {/* Is Applicable Discount? */}
                    <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                      <Typography sx={{ width: '150px', fontSize: '14px', color: '#6b7280' }}>
                        Is Applicable Discount? <span style={{ color: '#dc2626' }}>*</span>
                      </Typography>
                      <FormControl fullWidth size="small">
                        <Select displayEmpty defaultValue="">
                          <MenuItem value="">--Select--</MenuItem>
                    ...
                    <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                      <Typography sx={{ width: '150px', fontSize: '14px', color: '#6b7280' }}>
                        Paid Status <span style={{ color: '#dc2626' }}>*</span>
                      </Typography>
                      <FormControl fullWidth size="small">
                        <Select displayEmpty defaultValue="">
                          <MenuItem value="">--Select--</MenuItem>
                    ...
                    <Box sx={{ mb: 3, display: 'flex', alignItems: 'flex-start' }}>
                      <Typography sx={{ width: '150px', fontSize: '14px', color: '#6b7280', pt: 1 }}>
                        Note
                      </Typography>
                      <TextareaAutosize
                        minRows={4}
