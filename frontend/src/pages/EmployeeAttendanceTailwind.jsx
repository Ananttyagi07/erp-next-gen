/**
 * Employee Attendance Page - Material-UI Version
...
import EmployeeAttendanceListTailwind from '../components/modules/attendance/EmployeeAttendanceListTailwind';
import EmployeeAttendanceFormTailwind from '../components/modules/attendance/EmployeeAttendanceFormTailwind';
...
const EmployeeAttendanceTailwind = () => {
          ...
          <Box sx={{ p: 3 }}>
            ...
            {!isCollapsed && (
              <>
                ...
                {/* Filter/Search Form */}
                <EmployeeAttendanceFormTailwind onSearch={(data) => {}} />

                {/* Content Area - List View */}
                <EmployeeAttendanceListTailwind
...
export default EmployeeAttendanceTailwind;
