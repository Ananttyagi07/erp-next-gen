...
const ExamResultReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Exam Result Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="exam-result-report">
                <MenuItem value="exam-result-report">Exam Result Report</MenuItem>
              </Select>
            </FormControl>
          </Box>
          ...
          >
            {/* Single Row: 4 filter fields + Find button */}
