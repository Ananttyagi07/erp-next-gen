...
const StudentAttendanceReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Student Attendance Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="student-attendance-report">
                <MenuItem value="student-attendance-report">Student Attendance Report</MenuItem>
              </Select>
            </FormControl>
          </Box>

          {/* Filter Panel - 5 fields + Find button */}
          <Box
            sx={{
