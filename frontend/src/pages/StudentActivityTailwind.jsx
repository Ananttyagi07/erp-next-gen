/**
 * Student Activity Page - Material-UI Version
 * Manages student activities with list and form views
 */
...
import StudentActivityListTailwind from '../components/modules/student_activity/StudentActivityListTailwind';
import StudentActivityFormTailwind from '../components/modules/student_activity/StudentActivityFormTailwind';
          ...
          <Box sx={{ p: 3 }}>
            ...
            {!isCollapsed && (
              <>
                ...
                {/* Content Area */}
                {activeTab === 'list' ? (
                  <StudentActivityListTailwind
                    onSuccess={(msg) => setSuccess(msg)}
                    onError={(msg) => setError(msg)}
                  />
                ) : (
                  <StudentActivityFormTailwind
                    onSuccess={(msg) => setSuccess(msg)}
                    onError={(msg) => setError(msg)}
                  />
                )}
...
export default StudentActivityTailwind;
