/**
 * Bulk Admission Page - Material-UI Version
 * Handles bulk student admissions via CSV upload
 */
...
import BulkAdmissionForm from '../components/modules/bulk_admission/BulkAdmissionForm';
          ...
          <Box sx={{ p: 3 }}>
            ...
            {!isCollapsed && (
              <>
                ...
                {/* Content Area - Bulk Admission Form */}
                <BulkAdmissionForm
...
export default BulkAdmissionTailwind;
