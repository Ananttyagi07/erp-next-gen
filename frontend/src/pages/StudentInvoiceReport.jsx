...
const StudentInvoiceReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Student Invoice Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="student-invoice-report">
                <MenuItem value="student-invoice-report">Student Invoice Report</MenuItem>
              </Select>
            </FormControl>
          </Box>

          {/* Filter Panel - 4 fields + Find button */}
          <Box
            sx={{
