...
const DailyTransactionReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Daily Transaction Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="daily-transaction-report">
                <MenuItem value="daily-transaction-report">Daily Transaction Report</MenuItem>
              </Select>
            </FormControl>
          </Box>
          ...
          >
            {/* Row 1: 4 filter fields in one row */}
