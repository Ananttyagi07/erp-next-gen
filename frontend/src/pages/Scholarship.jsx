      ...
      <Box sx={{ p: 3 }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <NotificationsIcon sx={{ fontSize: 24, color: '#000' }} />
              ...
              <>
                ...
                >
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell colSpan={10} sx={{ textAlign: 'center', py: 4, borderBottom: '1px solid #e5e5e5' }}>
              ...
              <>
                ...
                <Box sx={{ maxWidth: '800px', mx: 'auto' }}>
                  ...
                  <Box sx={{ mb: 3 }}>
                    ...
                    >
                      Candidate <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
                        <MenuItem value="candidate1">Candidate 1</MenuItem>
                        <MenuItem value="candidate2">Candidate 2</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
