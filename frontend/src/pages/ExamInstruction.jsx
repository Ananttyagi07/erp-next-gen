...
const ExamInstruction = () => {
  ...
  const [instructionData] = useState([]);
          ...
          <Collapse in={headerExpanded}>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Typography variant="body2" sx={{ color: '#1976d2', display: 'inline' }}>
                <span style={{ cursor: 'pointer', color: '#000', fontWeight: 'bold' }}>Instruction</span> |{' '}
              ...
              <Box>
                ...
                <Box sx={{ display: 'flex', gap: 2, mt: 4, justifyContent: 'flex-end' }}>
                  ...
                  <Button
                    ...
                    disabled={!formData.schoolName || !formData.title || !formData.instruction}
                    sx={{
                      backgroundColor: '#000',
                      color: '#fff',
                      textTransform: 'none',
