            ...
            <>
              ...
              <TableContainer component={Paper} sx={{ boxShadow: 'none', border: '1px solid #e5e5e5', mb: 2 }}>
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      <TableCell colSpan={8} sx={{ textAlign: 'center', py: 4, color: '#6b7280', fontSize: '14px', borderBottom: 'none' }}>
          ...
          {selectedTab === 1 && (
            <Box>
              ...
              <Box sx={{ maxWidth: 800 }}>
                ...
                <Box sx={{ mb: 3, display: 'grid', gridTemplateColumns: '200px 1fr', gap: 2, alignItems: 'center' }}>
                  <Typography sx={{ fontSize: '14px', color: '#374151', fontWeight: 500, textAlign: 'right' }}>
                    Winner <span style={{ color: '#dc2626' }}>*</span>
                  </Typography>
                  <FormControl size="small">
                    <Select displayEmpty defaultValue="" sx={{ backgroundColor: '#fff', '& .MuiOutlinedInput-notchedOutline': { borderColor: '#e5e5e5' } }}>
                      <MenuItem value="">--Select--</MenuItem>
                ...
                <Box sx={{ mb: 3, display: 'grid', gridTemplateColumns: '200px 1fr', gap: 2, alignItems: 'center' }}>
                  <Typography sx={{ fontSize: '14px', color: '#374151', fontWeight: 500, textAlign: 'right' }}>
                    Gift <span style={{ color: '#dc2626' }}>*</span>
                  </Typography>
                  <TextField size="small" placeholder="Gift" sx={{ backgroundColor: '#fff', '& .MuiOutlinedInput-root': { '& fieldset': { borderColor: '#e5e5e5' } } }} />
                </Box>
                ...
                <Box sx={{ mb: 3, display: 'grid', gridTemplateColumns: '200px 1fr', gap: 2, alignItems: 'center' }}>
                  ...
                  <TextField size="small" placeholder="Price" sx={{ backgroundColor: '#fff', '& .MuiOutlinedInput-root': { '& fieldset': { borderColor: '#e5e5e5' } } }} />
                </Box>
                ...
                <Box sx={{ mb: 4, display: 'grid', gridTemplateColumns: '200px 1fr', gap: 2, alignItems: 'start' }}>
                  ...
                  <TextField multiline rows={6} placeholder="Note" sx={{ backgroundColor: '#fff', '& .MuiOutlinedInput-root': { '& fieldset': { borderColor: '#e5e5e5' } } }} />
                </Box>
