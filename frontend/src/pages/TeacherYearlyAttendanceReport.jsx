...
const TeacherYearlyAttendanceReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Teacher Yearly Attendance Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="teacher-yearly-attendance-report">
                <MenuItem value="teacher-yearly-attendance-report">Teacher Yearly Attendance Report</MenuItem>
              </Select>
            </FormControl>
          </Box>
          ...
          >
            <Box sx={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 2, alignItems: 'end' }}>
              ...
              <Box>
                <Typography sx={{ fontSize: '13px', color: '#374151', mb: 0.5, fontWeight: 500 }}>
                  Teacher <span style={{ color: '#dc2626' }}>*</span>
                </Typography>
                <FormControl fullWidth size="small">
                  <Select
                    displayEmpty
