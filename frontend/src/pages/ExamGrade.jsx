          ...
          <Collapse in={headerExpanded}>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Typography variant="body2" sx={{ color: '#1976d2', display: 'inline' }}>
                <span style={{ cursor: 'pointer', color: '#000', fontWeight: 'bold' }}>Exam Grade</span> |{' '}
                  ...
                  <Table>
                    <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                      <TableRow>
                        ...
                        <TableCell sx={{ color: '#666' }}>Grade Name</TableCell>
                        <TableCell sx={{ color: '#666' }}>Grade Point</TableCell>
                        <TableCell sx={{ color: '#666' }}>Mark From</TableCell>
                        <TableCell sx={{ color: '#666' }}>Mark To</TableCell>
                      ...
                      {gradeData.length === 0 ? (
                        ...
                        gradeData.map((item, index) => (
                          <TableRow key={index}>
                            ...
                            <TableCell>{item.markFrom}</TableCell>
                            <TableCell>{item.markTo}</TableCell>
            ...
            {activeTab === 1 && (
              <Box>
                <Grid container spacing={3}>
                  ...
                  <Grid item xs={12} md={3}>
                    <Typography variant="body1" sx={{ fontWeight: 'bold', color: '#666', mt: 2 }}>
                      Grade Point <span style={{ color: 'red' }}>*</span>
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={9}>
                    <TextField
                      ...
                      onChange={(e) => handleInputChange('gradePoint', e.target.value)}
                      sx={{ backgroundColor: '#fff', borderRadius: 1 }}
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} md={3}>
                    <Typography variant="body1" sx={{ fontWeight: 'bold', color: '#666', mt: 2 }}>
                      Mark From <span style={{ color: 'red' }}>*</span>
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={9}>
                    <TextField
                      ...
                      onChange={(e) => handleInputChange('markFrom', e.target.value)}
                      sx={{ backgroundColor: '#fff', borderRadius: 1 }}
                    />
                  </Grid>
                  ...
                  <Grid item xs={12} md={3}>
                    <Typography variant="body1" sx={{ fontWeight: 'bold', color: '#666', mt: 2 }}>
                      Mark To <span style={{ color: 'red' }}>*</span>
                    </Typography>
                  </Grid>
                  <Grid item xs={12} md={9}>
                    <TextField
                      ...
                      onChange={(e) => handleInputChange('markTo', e.target.value)}
                      sx={{ backgroundColor: '#fff', borderRadius: 1 }}
                    />
                  </Grid>
