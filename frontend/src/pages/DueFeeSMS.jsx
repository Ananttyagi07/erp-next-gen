  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      <Paper elevation={0} sx={{ border: '1px solid #e5e5e5', borderRadius: '4px' }}>
        ...
        >
          <SmsIcon sx={{ fontSize: 20, mr: 1, color: '#000' }} />
          ...
          <Box sx={{ p: 3 }}>
            ...
            <Box sx={{ borderBottom: '1px solid #e5e5e5', mb: 3 }}>
              ...
              >
                ...
                <Tab icon={<AddIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Send SMS" />
              </Tabs>
            </Box>
              ...
              <Box>
                ...
                <TableContainer sx={{ border: '1px solid #e5e5e5', borderRadius: '4px', mb: 2 }}>
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell colSpan={6} sx={{ textAlign: 'center', py: 4, color: '#6b7280', fontSize: '14px' }}>
              ...
              <Box>
                <Box sx={{ maxWidth: '800px' }}>
                  ...
                  <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                    <Typography sx={{ width: '200px', fontSize: '14px', color: '#6b7280' }}>
                  ...
                  <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                    <Typography sx={{ width: '200px', fontSize: '14px', color: '#6b7280' }}>
                      Due Fee Student <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
                  ...
                  <Box sx={{ mb: 1, display: 'flex', alignItems: 'flex-start' }}>
                    <Typography sx={{ width: '200px', fontSize: '14px', color: '#6b7280', pt: 1 }}>
                  ...
                  <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                    <Box sx={{ width: '200px' }} />
                    <Typography sx={{ fontSize: '14px', color: '#6b7280' }}>
                      You have remain character/ letter: 160
                    </Typography>
                  </Box>
                  ...
                  <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                      <Link href="#" sx={{ color: '#2563eb', textDecoration: 'none', fontSize: '14px', '&:hover': { textDecoration: 'underline' } }}>
                        [name]
                      </Link>
                      <Link href="#" sx={{ color: '#2563eb', textDecoration: 'none', fontSize: '14px', '&:hover': { textDecoration: 'underline' } }}>
                        [email]
