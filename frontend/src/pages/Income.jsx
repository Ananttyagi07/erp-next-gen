              ...
              <Box>
                ...
                <TableContainer sx={{ border: '1px solid #e5e5e5', borderRadius: '4px', mb: 2 }}>
                  <Table>
                    ...
                    <TableBody>
                      <TableRow>
                        <TableCell colSpan={7} sx={{ textAlign: 'center', py: 4, color: '#6b7280', fontSize: '14px' }}>
            ...
            {selectedTab === 1 && (
              <Box>
                <Box sx={{ maxWidth: '800px' }}>
                  ...
                  <Box sx={{ mb: 3 }}>
                    <Typography sx={{ fontSize: '14px', color: '#6b7280', mb: 1, fontWeight: 600 }}>
                      Income Head <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
                        <MenuItem value="head1">Income Head 1</MenuItem>
                        <MenuItem value="head2">Income Head 2</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
                  ...
                  <Box sx={{ mb: 3 }}>
                    <Typography sx={{ fontSize: '14px', color: '#6b7280', mb: 1, fontWeight: 600 }}>
                      Income Method <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
