...
const EmployeeAttendanceReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Employee Attendance Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="employee-attendance-report">
                <MenuItem value="employee-attendance-report">Employee Attendance Report</MenuItem>
              </Select>
            </FormControl>
          </Box>
