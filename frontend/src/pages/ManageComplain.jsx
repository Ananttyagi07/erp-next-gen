      ...
      <Box sx={{ p: 3 }}>
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <DocumentIcon sx={{ fontSize: 24, color: '#000' }} />
              ...
              <>
                ...
                <Box sx={{ maxWidth: '800px', mx: 'auto' }}>
                  ...
                  <Box sx={{ mb: 3 }}>
                    ...
                    >
                      Complain By <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
                  ...
                  <Box sx={{ mb: 3 }}>
                    ...
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
                        <MenuItem value="type1">Daily Complaint</MenuItem>
                        <MenuItem value="type2">Weekly Complaint</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
                  ...
                  <Box sx={{ mb: 3 }}>
                    ...
                    >
                      Complain Date <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <TextField
                      fullWidth
                      size="small"
                  ...
                  <Box sx={{ mb: 4 }}>
                    ...
                    >
                      Complain <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <TextField
                      fullWidth
                      multiline
