/**
 * Manage Absent SMS Page - Material-UI Version
 * Manages absent SMS records with List and Send SMS views
 */
...
import ManageAbsentSMSListTailwind from '../components/modules/absent_sms/ManageAbsentSMSListTailwind';
import ManageAbsentSMSFormTailwind from '../components/modules/absent_sms/ManageAbsentSMSFormTailwind';
          ...
          <Box sx={{ p: 3 }}>
            ...
            <Box sx={{
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                <MessageIcon sx={{ fontSize: 28, color: '#333' }} />
            ...
            {!isCollapsed && (
              <>
                ...
                <Box>
                  {activeTab === 'list' && (
                    <ManageAbsentSMSListTailwind
                      onSuccess={(msg) => setSuccess(msg)}
                      onError={(msg) => setError(msg)}
                    />
                  )}
                  {activeTab === 'send' && (
                    <ManageAbsentSMSFormTailwind />
                  )}
                </Box>
              </>
            )}
...
export default ManageAbsentSMSTailwind;
