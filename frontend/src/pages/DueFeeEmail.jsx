          ...
          <Box sx={{ p: 3 }}>
            ...
            <Box sx={{ borderBottom: '1px solid #e5e5e5', mb: 3 }}>
              ...
              >
                ...
                <Tab icon={<SendIcon sx={{ fontSize: 18 }} />} iconPosition="start" label="Send Email" />
              </Tabs>
            </Box>
            ...
            {selectedTab === 1 && (
              <Box>
                <Box sx={{ maxWidth: '800px' }}>
                  ...
                  <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                    <Typography sx={{ width: '200px', fontSize: '14px', color: '#6b7280' }}>
                      Receiver Type / Role <span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <FormControl fullWidth size="small">
                      <Select displayEmpty defaultValue="">
                        <MenuItem value="">--Select--</MenuItem>
                  ...
                  <Box sx={{ mb: 3, display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography sx={{ fontSize: '14px', color: '#6b7280' }}>
                      [student_name], [class], [due_amount], [school_name]
                    </Typography>
                  </Box>
                </Box>
