                  ...
                  <Table>
                    <TableHead sx={{ backgroundColor: '#f8f8f8' }}>
                      <TableRow>
                        ...
                        <TableCell sx={{ fontWeight: 600, borderBottom: '1px solid #e5e5e5' }}>Room No</TableCell>
                        <TableCell sx={{ fontWeight: 600, borderBottom: '1px solid #e5e5e5' }}>Room Type</TableCell>
                        <TableCell sx={{ fontWeight: 600, borderBottom: '1px solid #e5e5e5' }}>Seat Total</TableCell>
                        <TableCell sx={{ fontWeight: 600, borderBottom: '1px solid #e5e5e5' }}>Hostel</TableCell>
                        <TableCell sx={{ fontWeight: 600, borderBottom: '1px solid #e5e5e5' }}>Cost per Seat</TableCell>
              ...
              <Box component="form" onSubmit={handleSubmit}>
                <Box sx={{ maxWidth: '800px', mx: 'auto' }}>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                    ...
                    >
                      Seat Total<span style={{ color: '#dc2626' }}>*</span>
                    </Typography>
                    <TextField
                      fullWidth
                      size="small"
                      name="seatTotal"
                      value={formData.seatTotal}
                      onChange={handleInputChange}
                      sx={{
                        '& .MuiOutlinedInput-root': {
                          borderRadius: '4px',
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                    ...
                    <FormControl fullWidth size="small">
                      ...
                      >
                        ...
                        <MenuItem value="hostel1">Hostel 1</MenuItem>
                        <MenuItem value="hostel2">Hostel 2</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
