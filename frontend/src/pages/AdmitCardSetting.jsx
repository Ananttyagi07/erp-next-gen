...
const AdmitCardSetting = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    admitTitleFontSize: '',
    admitTitleColor: '#000000',
    admitTitleBackground: '#ffffff',
    titleFontSize: '',
    titleColor: '#000000',
    valueFontSize: '',
    valueColor: '#000000',
    examTitleFontSize: '',
    examTitleColor: '#000000',
    subjectFontSize: '',
    subjectColor: '#000000',
    bottomSignature: '',
  ...
  // Sample data - empty for "No data available" state
          ...
          <Collapse in={headerExpanded}>
            ...
            <Box sx={{ mt: 2, mb: 2 }}>
              <Typography variant="body2" sx={{ color: '#1976d2' }}>
                ...
                <span style={{ cursor: 'pointer', color: '#000', fontWeight: 'bold' }}>Admit Card Setting</span> |{' '}
          ...
          {activeTab === 1 && (
            <Box>
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={3}>
                  <Typography variant="body1" sx={{ fontWeight: 'bold', mt: 2 }}>
                    Admit Title Font Size
                  </Typography>
                </Grid>
                <Grid item xs={12} md={9}>
                  <TextField
                    fullWidth
                    value={formData.admitTitleFontSize}
                    onChange={(e) => handleInputChange('admitTitleFontSize', e.target.value)}
                    sx={{ backgroundColor: '#f0f0f0' }}
                  />
                </Grid>
                ...
                <Grid item xs={12} md={9}>
                  <ColorPickerInput
                    value={formData.admitTitleColor}
                    onChange={(val) => handleInputChange('admitTitleColor', val)}
                ...
                <Grid item xs={12} md={3}>
                  <Typography variant="body1" sx={{ fontWeight: 'bold', mt: 2 }}>
                    Admit Title Background
                  </Typography>
                </Grid>
                <Grid item xs={12} md={9}>
                  <ColorPickerInput
                    value={formData.admitTitleBackground}
                    onChange={(val) => handleInputChange('admitTitleBackground', val)}
                ...
                <Grid item xs={12} md={3}>
                  <Typography variant="body1" sx={{ fontWeight: 'bold', mt: 2 }}>
                    Exam Title Font Size
                  </Typography>
                </Grid>
                <Grid item xs={12} md={9}>
                  <TextField
                    fullWidth
                    value={formData.examTitleFontSize}
                    onChange={(e) => handleInputChange('examTitleFontSize', e.target.value)}
                    sx={{ backgroundColor: '#f0f0f0' }}
                  />
                </Grid>
                ...
                <Grid item xs={12} md={9}>
                  <ColorPickerInput
                    value={formData.examTitleColor}
                    onChange={(val) => handleInputChange('examTitleColor', val)}
                ...
                <Grid item xs={12} md={9}>
                  <TextField
                    fullWidth
                    value={formData.subjectFontSize}
                    onChange={(e) => handleInputChange('subjectFontSize', e.target.value)}
                    sx={{ backgroundColor: '#f0f0f0' }}
                  />
                </Grid>
                ...
                <Grid item xs={12} md={9}>
                  <ColorPickerInput
                    ...
                    onChange={(val) => handleInputChange('subjectColor', val)}
                    label="Subject Color"
                  />
                </Grid>
                ...
                <Grid item xs={12} md={9}>
                  <FormControl fullWidth sx={{ backgroundColor: '#f0f0f0' }}>
