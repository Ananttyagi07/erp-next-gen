...
const DailyStatementReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Daily Statement Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="daily-statement-report">
                <MenuItem value="daily-statement-report">Daily Statement Report</MenuItem>
              </Select>
            </FormControl>
          </Box>
          ...
          >
            {/* Single Row: 3 filter fields + Find button */}
