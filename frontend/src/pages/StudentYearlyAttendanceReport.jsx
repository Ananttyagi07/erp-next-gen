...
const StudentYearlyAttendanceReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Student Yearly Attendance Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="student-yearly-attendance-report">
                <MenuItem value="student-yearly-attendance-report">Student Yearly Attendance Report</MenuItem>
              </Select>
            </FormControl>
          </Box>

          {/* Filter Panel - 6 fields + Find button */}
          <Box
            sx={{
