...
const EmployeeYearlyAttendanceReport = () => {
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#fff', minHeight: '100vh' }}>
      ...
      {/* Expandable Section - Employee Yearly Attendance Report */}
      <Box
        sx={{
          display: 'flex',
          alignItems: 'center',
      ...
      >
        ...
        <Typography sx={{ fontSize: '16px', fontWeight: 600, color: '#000', flex: 1 }}>
          Employee Yearly Attendance Report
        </Typography>
        {isCollapsed ? (
        ...
        <>
          ...
          <Box sx={{ mb: 3 }}>
            <FormControl size="small" sx={{ minWidth: 250 }}>
              <Select defaultValue="employee-yearly-attendance-report">
                <MenuItem value="employee-yearly-attendance-report">Employee Yearly Attendance Report</MenuItem>
              </Select>
            </FormControl>
          </Box>
