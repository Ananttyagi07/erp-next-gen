/**
 * Manage Submission Component
 * Handles assignment submission management
 */
...
const ManageSubmission = () => {
  ...
  const assignments = [
    { id: 1, name: 'Data Structure Assignment 1' },
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      const allowedFormats = ['pdf', 'doc', 'docx', 'ppt', 'pptx', 'jpg', 'jpeg', 'txt'];
      ...
      if (allowedFormats.includes(fileExtension)) {
        ...
        setSubmitStatus({ type: 'error', message: 'Invalid file format. Please upload doc, docx, jpg, jpeg, pdf, ppt, pptx, or txt' });
  ...
  const validateForm = () => {
    ...
    if (!formData.assignment) errors.assignment = 'Assignment is required';
    return errors;
  };
  ...
  const handleSubmit = (e) => {
    ...
    setSubmitStatus({ type: 'success', message: 'Submission created successfully!' });
    setFormData({
      school: '',
      class: '',
      section: '',
  ...
  const getEvaluateColor = (evaluate) => {
    const colors = {
      'Pending': '#ff9800',
      'Evaluated': '#4caf50',
      'Not Submitted': '#f44336',
    };
    return colors[evaluate] || '#666';
  };
        ...
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
              <UploadCloudIcon sx={{ fontSize: 28, color: '#333' }} />
                    ...
                    <Table>
                      <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                        <TableRow>
                          ...
                          <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>
                            Assignment <UnfoldMoreIcon sx={{ fontSize: 16, ml: 0.5 }} />
                          </TableCell>
                          <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>
                          ...
                          <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>
                            Submitted By <UnfoldMoreIcon sx={{ fontSize: 16, ml: 0.5 }} />
                          </TableCell>
                          <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>
                            Submitted At <UnfoldMoreIcon sx={{ fontSize: 16, ml: 0.5 }} />
                          </TableCell>
                          <TableCell sx={{ fontWeight: 600, fontSize: '0.9rem' }}>
                            Evaluate <UnfoldMoreIcon sx={{ fontSize: 16, ml: 0.5 }} />
                          </TableCell>
                            ...
                            <TableRow key={index} sx={{ '&:hover': { backgroundColor: '#f9f9f9' } }}>
                              ...
                              <TableCell>
                                <Chip
                                  ...
                                  size="small"
                                  sx={{
                                    backgroundColor: getEvaluateColor(item.evaluate),
                                    color: '#fff',
                                    fontWeight: 500,
                                  }}
                                />
                  ...
                  <form onSubmit={handleSubmit}>
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12}>
                        <Box sx={{ display: 'flex', gap: 2 }}>
                          <Typography sx={{ fontWeight: 600, width: '20%', pt: 1 }}>
                            Student <span style={{ color: '#f44336' }}>*</span>
                          </Typography>
                        ...
                        {formErrors.student && <Typography sx={{ color: '#f44336', fontSize: '0.75rem', mt: 0.5 }}>{formErrors.student}</Typography>}
                      </Grid>
                      ...
                      <Grid item xs={12}>
                        <Box sx={{ display: 'flex', gap: 2 }}>
                          <Typography sx={{ fontWeight: 600, width: '20%', pt: 1 }}>
                            Assignment <span style={{ color: '#f44336' }}>*</span>
                          </Typography>
                          <FormControl fullWidth error={!!formErrors.assignment}>
                            <InputLabel>--Select--</InputLabel>
                            <Select
                              name="assignment"
                        ...
                        {formErrors.assignment && <Typography sx={{ color: '#f44336', fontSize: '0.75rem', mt: 0.5 }}>{formErrors.assignment}</Typography>}
                      </Grid>
                      ...
                      <Grid item xs={12}>
                        <Box sx={{ display: 'flex', gap: 2 }}>
                          ...
                          <Box sx={{ width: '80%' }}>
                            <input
                              accept=".pdf,.doc,.docx,.ppt,.pptx,.jpg,.jpeg,.txt"
                              style={{ display: 'none' }}
                              id="file-upload"
                              type="file"
