/**
 * Manage Declined Application Component
 * Displays declined leave applications with list and filtering
...
const ManageDeclinedApplication = () => {
  ...
  const [declinedApplications] = useState([]);
  ...
  return (
    <Box>
      ...
      <Paper sx={{ boxShadow: 1 }}>
        ...
        {/* Quick Links */}
        <Box sx={{ p: 2, borderBottom: '1px solid #e0e0e0', display: 'flex', gap: 3, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <Table>
            ...
            <TableBody>
              {declinedApplications.length === 0 ? (
                ...
                declinedApplications.map((app, index) => (
...
export default ManageDeclinedApplication;
