/**
 * Manage Approved Application Component
 * Displays approved leave applications with list and filtering
...
const ManageApprovedApplication = () => {
...
export default ManageApprovedApplication;
