/**
 * Online Admission List Component - Material-UI Version
 * Displays list of online admissions in table format
 */
...
const OnlineAdmissionListTailwind = () => {
        ...
        <Table>
          <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
            <TableRow>
              ...
              <SortableHeader column="photo" label="Photo" />
                  ...
                  <TableCell>
                    <Box
                      sx={{
                        ...
                        fontSize: '0.8rem',
                        fontWeight: 500,
                        bgcolor: admission.status === 'Approved' ? '#d4edda' :
                                 admission.status === 'Pending' ? '#fff3cd' : '#f8d7da',
                        color: admission.status === 'Approved' ? '#155724' :
                               admission.status === 'Pending' ? '#856404' : '#721c24'
                      }}
                    >
                      {admission.status}
                    </Box>
...
export default OnlineAdmissionListTailwind;
