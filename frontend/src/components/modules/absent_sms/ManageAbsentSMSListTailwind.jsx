/**
 * Manage Absent SMS List Component - Material-UI Version
 * Displays absent SMS records in a sortable table with toolbar
 */
...
const ManageAbsentSMSListTailwind = () => {
        ...
        <Table>
          <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
            <TableRow>
              ...
              <SortableHeader column="sessionYear" label="Session Year" />
          ...
          <TableBody>
            {SAMPLE_SMS.length === 0 ? (
              ...
              SAMPLE_SMS.map((sms, index) => (
                <TableRow key={index} hover>
                  <TableCell sx={{ fontSize: '0.9rem' }}>{index + 1}</TableCell>
                  <TableCell sx={{ fontSize: '0.9rem' }}>{sms.school}</TableCell>
                  <TableCell sx={{ fontSize: '0.9rem' }}>{sms.sessionYear}</TableCell>
                  <TableCell sx={{ fontSize: '0.9rem' }}>{sms.receiverType}</TableCell>
                  <TableCell sx={{ fontSize: '0.9rem' }}>{sms.sendDate}</TableCell>
                  <TableCell>
                    <Button
                      size="small"
                      variant="contained"
...
export default ManageAbsentSMSListTailwind;
