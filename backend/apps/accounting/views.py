...
class InvoiceViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        """Filter by the branch selected via X-School-Id (see Dashboard/Students/Teachers for the same pattern)"""
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        """Filter by the branch selected via X-School-Id"""
        # Payment (unlike Invoice) isn't a SoftDeleteModel — it has no
        # is_deleted field. Filtering on it unconditionally 500'd every
